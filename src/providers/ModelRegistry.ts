...
export class ModelRegistry {
  ...
  private models: Map<ProviderType, ModelInfo[]> = new Map();
   ...
   */
  public getModelsForProvider(provider: ProviderType): ModelInfo[] {
   ...
   */
  public findModelById(modelId: string, provider?: ProviderType): ModelInfo | undefined {
    if (provider) {
...
// Re-export ModelInfo type for convenience
